 ...
 * <ul>
 * <li>{@link org.com.ad_board_common.dao.CrudDAO} - the basic interface for all DAO implementations, providing standard
 ...
 * <li>{@link org.com.ad_board_common.dao.AdDAO} - provides access to data for the advertising object.</li>
 * <li>{@link org.com.ad_board_common.dao.EmailDAO} - provides access to data for the email entity.</li>
 * <li>{@link org.com.ad_board_common.dao.MatchingAdDAO} - provides access to data for a matching ad entity.</li>
 * </ul>
 *
 * <h2>Usage</h2>
 ...
 *
 * @see org.com.ad_board_common.dao.CrudDAO
 * @see org.com.ad_board_common.dao.AdDAO
 * @see org.com.ad_board_common.dao.EmailDAO
 * @see org.com.ad_board_common.dao.MatchingAdDAO
 */
